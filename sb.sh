...
# ==========================================
# Sing-box 6-in-1 极致稳定架构版 (v6.4.2 视觉终极防弹版)
# 特性：纯 ASCII 绝对对齐防乱码，分离部署，全协议默认开启，支持 Argo 独立管理
# ==========================================
...
print_logo() {
    clear
    echo -e "${PURPLE}╭━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╮${NC}"
    echo -e "${PURPLE}┃${NC}  ${CYAN}   _____ __  _   ________       ____  ____ _  __  ${NC}  ${PURPLE}┃${NC}"
    echo -e "${PURPLE}┃${NC}  ${CYAN}  / ___// / / | / / ____/      / __ )/ __ \\ |/ /  ${NC}  ${PURPLE}┃${NC}"
    echo -e "${PURPLE}┃${NC}  ${CYAN}  \\__ \\/ / /  |/ / / __ ______/ __  / / / /   /   ${NC}  ${PURPLE}┃${NC}"
    echo -e "${PURPLE}┃${NC}  ${CYAN} ___/ / / / /|  / /_/ //_____/ /_/ / /_/ /   |    ${NC}  ${PURPLE}┃${NC}"
    echo -e "${PURPLE}┃${NC}  ${CYAN}/____/_/ /_/ |_/\\____/      /_____/\\____/_/|_|    ${NC}  ${PURPLE}┃${NC}"
    divider
    echo -e "${PURPLE}┃${NC}     ${YELLOW}${BOLD}✨ Kele's Sing-box 6-in-1 主流稳定协议 (v6.6) ✨${NC}     ${PURPLE}┃${NC}"
    echo -e "${PURPLE}╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯${NC}"
    echo ""
}
